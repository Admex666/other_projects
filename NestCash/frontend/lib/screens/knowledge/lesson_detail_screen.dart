  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color(0xFF00D4A3),
          title: const Text('Betöltés...', style: TextStyle(color: Colors.white)),
          leading: IconButton(
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              if (page.title != null) const SizedBox(height: 16),
              Container(
    ...
    return Container(
      ...
      child: Row(
        children: [
          if (currentPageIndex > 0)
            Expanded(
              child: ElevatedButton.icon(
                ...
                icon: const Icon(Icons.arrow_back, color: Colors.white),
                label: const Text('Előző', style: TextStyle(color: Colors.white)),
                style: ElevatedButton.styleFrom(
          ...
          if (currentPageIndex > 0) const SizedBox(width: 12),
          Expanded(
            child: ElevatedButton.icon(
