...
*   **Nagy-Kevély Landing Page Megújítás (UPDATED 2026-07-13):**
    ...
    *   **Adatbázis Normalizáció & Több Kihívás Támogatása (COMPLETED 2026-07-16):**
        ...
        *   **Google Sheets Teljes Leválasztás és Supabase Migráció (COMPLETED 2026-07-21):** Teljesen megszüntettük a Google Sheets függőséget a fizetési, limit-ellenőrzési és visszajelzési folyamatokban (`api/checkout.js`, `api/check-limit.js` és `api/submit-feedback.js`). A rendszer mostantól 100%-ban Supabase alapon működik, függetlenül a Google Sheetstől.
        *   **Foxpost API Közvetlen Feladás & Követés (COMPLETED 2026-07-21):** Kialakítottunk egy teljesen automatizált Foxpost csomagfeladást közvetlenül az admin felületről. Egy kattintással beküldjük a csomagot a Foxpost API-nak, az egyedi vonalkódot elmentjük a `shipments.tracking_code` oszlopba. A háttérben futó követő script (`daily_tracking.py`) folyamatosan frissíti a státuszokat, és átvétel után automatikusan kiküldi az Ajánlói Program levelet a promoter (NPS 9-10) túrázóknak.
