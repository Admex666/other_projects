                        ...
                        {session.status === 'active' && (
                            <div className="flex flex-col items-end space-y-2">
                                ...
                                <form action={async () => {
                                    ...
                                    <button type="submit" className="text-sm underline text-red-600 hover:text-red-800">
                            ...
                            {session.participants.map((p) => (
                                <li key={p.id} className="py-3 flex justify-between items-center">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">{p.user.role} &bull; {p.user.teamMembership}</p>
                                    </div>
